...
export const LORE_CHAMPIONS = {
  ...
  PIROSKA: {
    ...
    skills: [
      { key: "Q", th: "Wolfsbane Powder", type: "cone", range: 700, count: 7, angle: 50, falloff: 0.5,
        cast: 0.25, cd: 9, cdByRank: [9, 8.5, 8, 7.5, 7], magic: true,
        dmg: [50, 80, 110, 140, 170], apRatio: 0.40,
        slow: [0.30, 0.30, 0.30, 0.30, 0.30], dur: 2.5,
  ...
  HOOD: {
    ...
    skills: [
      { key: "Q", th: "Sherwood Longdraw", type: "rangeCharge", width: 120, projSpeed: 1850,
        rangeMin: 600, rangeMax: 1500, maxCharge: 2.5, selfSlow: 0.2, pierce: true, falloff: 0.9, falloffFloor: 0.6,
        cast: 0.2, cd: 15, cdByRank: [15, 14, 13, 12, 11],
        dmg: [150, 200, 250, 300, 350], badRatio: 0.70,
        fullDmg: [225, 325, 425, 525, 625], fullBadRatio: 1.50 },
  ...
  PUSS: {
    ...
    duel: { amp: 0.15, ampPerBad: 0.025 / 100, goldPct: 0.30, reviveHp: 0.30, hideDur: 2.0,
      pickLockRounds: 1, repickAfterKills: 2 },
  ...
  "H.S.B": {
    ...
    threePigs: [
      { at: 1.00, size: 1.00, skill: 1.00, build: 1.00, dr: 0.10 },
      { at: 0.75, size: 0.90, skill: 1.15, build: 1.20, dr: 0 },
      { at: 0.50, size: 0.80, skill: 1.30, build: 1.50, dr: -0.10 },
    ],
    ...
    skills: [
      ...
      { key: "W", th: "Brick Bastion", type: "wall", range: 500, span: 500, life: 10,
        cast: 0.3, cd: 12, cdByRank: [12, 11.5, 11, 10.5, 10],
        hp: [500, 600, 700, 800, 900], hpBonusHp: 0.50,
        res: [30, 45, 60, 75, 90], resRatio: 0.75 },
      // พุ่งทะลุ ชนกำแพงแล้วระเบิดกระแทกลอย
      { key: "E", th: "Boarhead Breaker", type: "steerDash", dashRange: 750, dashSpeed: 1000,
        cast: 0, cd: 12, cdByRank: [12, 11, 10, 9, 8],
        dmg: [75, 125, 175, 225, 275], selfBonusHp: 0.075,
        hitRadius: 350, hitDmg: [100, 155, 210, 265, 320], hitBadRatio: 0.80, hitBonusHp: 0.15,
        // กดแล้วได้โล่ทันที ไม่ต้องรอว่าจะชนใคร
        castShield: [200, 250, 300, 350, 400], castShieldBonusHp: 0.15, castShieldDur: 4,
        knockup: 1.25 },
