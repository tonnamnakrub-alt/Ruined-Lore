...
export const PATCHES = [
  {
    ...
    rev: "",
    date: "2026-09-26",
    title: "รอบปรับตัวละครใหญ่ — ยกหกตัว กดหกตัว",
    blurb: "ตัวที่จมอยู่ท้ายตารางได้ของใหม่และตัวเลขที่ใช้ได้จริง ส่วนตัวที่กินขาดโดนกดลงมา",
    groups: [
      {
        kind: "buff",
        head: "H.S.B — รื้อทั้งชุด",
        lines: [
      ...
      {
        kind: "buff",
        head: "ALUCARD · HOOD · PUSS · KLAEDER · FAUSTUS",
        lines: [
      ...
      {
        kind: "nerf",
        head: "PIROSKA · YODAKA · NIAN · JACK · ELLA · ARTHUR",
        lines: [
  ...
  },
  {
    ...
    groups: [
      ...
      {
        kind: "buff",
        head: "PIROSKA ตะกร้าวงกว้างขึ้น แต่ดูแลได้ทีละไม่กี่คน · ALICE Q ระยะสั้นลง",
        lines: [
      ...
      {
        kind: "system",
        head: "ค่าสถานะหลักของไอเทมหารห้าลงตัวหมดแล้ว",
        lines: [
      ...
      {
        kind: "note",
        head: "Horn of the Wild Hunt มีพาสซีฟอยู่แล้ว แค่ไม่เคยมีใครเห็น",
        lines: [
      ...
      {
        kind: "nerf",
        head: "รอบปรับไอเทม — กดของที่แรงเกิน ยกของที่สายอ่อนใช้",
        lines: [
      ...
      {
        kind: "nerf",
        head: "ลดความเร็วพุ่งและความเร็วลูกของตัวที่อัตราชนะสูง",
        lines: [
      ...
      {
        kind: "system",
        head: "ค่าสถานะนักแข่ง — เปลี่ยนเป็นความคิดของบอท ไม่ใช่ตัวเลขลับหลัง",
        lines: [
      ...
      {
        kind: "nerf",
        head: "ป่าไปแกงค์ไม่ได้รายได้ฐานแล้ว · รุกล้ำ 8 เป็น 7",
        lines: [
      ...
      {
        kind: "note",
        head: "แก้ของที่ไม่ทำงานในห้องซ้อม และ ELLA ออกจากซัพ",
        lines: [
      ...
      {
        kind: "buff",
        head: "รอบปรับหลังรีเวิร์ค — TOTSAKAN กับ YODAKA",
        lines: [
      ...
      {
        kind: "new",
        head: "รีเวิร์ค TOTSAKAN — จาก Vanguard เป็น Juggernaut",
        lines: [
      ...
      {
        kind: "system",
        head: "เลือดไหลจ่ายเป็นงวด ไม่ใช่ทุกเฟรม",
        lines: [
