...
export const ITEMS = [
  ...
  { id: "stc", th: "Surtr's Twilight Cinder — เถ้าอัคคีสุรเทอร์", cat: "MAGE", tier: 3, cost: 62,
    ap: 60, hp: 300, burnPctHp: { pct: 0.02, dur: 3 }, parts: ["cbl", "wbp"] },
  ...
  { id: "nvs", th: "Nemesis' Vengeful Scales — ตราชั่งล้างแค้นเนเมซิส", cat: "MAGE", uniq: ["antiheal"], also: ["SUPPORT"], tier: 3, cost: 64,
    ap: 75, ah: 15, mrPen: 20, storedBurst: { dur: 2.5, flat: 100, accRatio: 0.20, cd: 25 }, parts: ["cyw", "orl"] },
  ...
  { id: "sst", th: "Shiva's Trishula — ตรีศูลทำลายล้างพระศิวะ", cat: "MARKSMAN", also: ["FIGHTER"], tier: 3, cost: 60,
    ad: 45, asPct: 0.30, armorPenPct: 0.30, parts: ["hwt", "exn"] },
  ...
  { id: "hmb", th: "Hermes' Moly Blossom — ดอกโมลีแห่งเฮอร์มีส", cat: "SUPPORT", uniq: ["cleanse"], tier: 3, cost: 48,
    ap: 30, ah: 15, hp: 100, hors: 0.15, cleanseAll: true, parts: ["ccr", "isw"] },
  ...
  { id: "cbc", th: "Cuirass of the Bleeding Centaur — เกราะเลือดเซนทอร์", cat: "FIGHTER", also: ["TANK"], tier: 3, cost: 62,
    ad: 50, armor: 40, ah: 15,
  ...
  { id: "hwh", th: "Horn of the Wild Hunt — เขาศึกไวลด์ฮันต์", cat: "FIGHTER", also: ["MARKSMAN"], tier: 3, cost: 60,
    ad: 40, hp: 300, asPct: 0.2, ultAh: 25, parts: ["hwt", "wha", "cc"] },
  ...
  { id: "adm", th: "Anubis' Death Mark — มีดชี้ชะตาอนูบิส", cat: "ASSASSIN", tier: 3, cost: 62,
    ad: 50, arPen: 15, ah: 10,
