...
export const ITEMS = [
  ...
  { id: "cb", th: "Chaos Blade — ดาบอลวน", cat: "START", tier: 1, cost: 10, ad: 10, hp: 90, omnivampFlat: 0.04 },
  { id: "cs", th: "Chaos Scroll — คัมภีร์อลวน", cat: "START", tier: 1, cost: 10, ap: 30, hp: 70 },
  { id: "csh", th: "Chaos Shield — โล่อลวน", cat: "START", tier: 1, cost: 10, hp: 140, armor: 10, mr: 10 },
  { id: "cbw", th: "Chaos Bow — คันศรอลวน", cat: "START", tier: 1, cost: 10, ad: 10, asPct: 0.15 },
  { id: "cd", th: "Chaos Dagger — กริชอลวน", cat: "START", tier: 1, cost: 10, ad: 10, ap: 10, pen: 10 },
  { id: "cch", th: "Chaos Chalice — จอกอลวน", cat: "START", tier: 1, cost: 10, hp: 120, hors: 0.10 },
  ...
  { id: "ftf", th: "Fenrir's Torn Fang — เขี้ยวหักเฟนริร์", cat: "T1", tier: 1, cost: 6, pen: 6 },
  ...
  { id: "toh", th: "Talaria of Hermes — ปีกเฮอร์มีส", cat: "BOOTS", tier: 2, kind: "boots", cost: 25, ms: 65, parts: ["ss"] },
  { id: "cp", th: "Chimera's Prowlers — กรงเล็บไคเมร่า", cat: "BOOTS", tier: 2, kind: "boots", cost: 25,
    ms: 45, ad: 10, ap: 20, pen: 7, parts: ["ss", "bt2", "wt"] },
  ...
  { id: "eoh", th: "Eye of Horus — ดวงตาแห่งฮอรัส", cat: "MAGE", tier: 3, cost: 58,
    ap: 65, ah: 10, mrPenPct: 0.35, parts: ["mwh", "orl"] },
  { id: "kff", th: "Kitsune's Foxfire Fan — พัดเพลิงจิ้งจอกเก้าหาง", cat: "MAGE", also: ["MARKSMAN"], tier: 3, cost: 60,
    ap: 50, asPct: 0.30, ah: 10, apOnHit: { flat: 15, apRatio: 0.20 }, parts: ["cyw", "cf", "bsd"] },
  ...
  { id: "esb", th: "Eir's Sanctuary Bell — ระฆังเขตบุญแห่งเออีร์", cat: "SUPPORT", tier: 3, cost: 48,
    hp: 250, ah: 15, hors: 0.12, parts: ["ccr", "nd"] },
  { id: "abw", th: "Aeolus' Bound Winds — ถุงลมกักวายุแอโอลัส", cat: "SUPPORT", tier: 3, cost: 46,
    ap: 35, ah: 10, ms: 20, hors: 0.08, parts: ["ngv", "ccr"] },
  { id: "hmb", th: "Hermes' Moly Blossom — ดอกโมลีแห่งเฮอร์มีส", cat: "SUPPORT", uniq: ["cleanse"], tier: 3, cost: 48,
    ap: 30, ah: 15, hp: 100, hors: 0.12, parts: ["ccr", "isw"] },

  // --- ซัพพอร์ตสายแทงค์ Tier 3
  { id: "pib", th: "Pridwen's Iron Bastion — ป้อมปราการเหล็กพริตเวน", cat: "SUPPORT", also: ["TANK"], tier: 3, cost: 48,
    hp: 200, armor: 25, mr: 25, parts: ["gb", "nd"] },
  ...
  { id: "ood", th: "Oath of the Dioscuri — คำสัตย์แห่งไดออสคูรี", cat: "SUPPORT", also: ["TANK"], tier: 3, cost: 48,
    hp: 300, armor: 30, ah: 10, parts: ["gpr", "pon"] },

  // --- แทงค์ Tier 3
  { id: "nlm", th: "Nemean Lion's Mane — แผงคอสิงโตเนเมียน", cat: "TANK", tier: 3, cost: 60,
    hp: 400, armor: 90, parts: ["cn", "gpr", "bc"] },
  { id: "pmh", th: "Prometheus' Hearth — เตาไฟโพรมีธีอุส", cat: "TANK", uniq: ["antiheal"], also: ["FIGHTER"], tier: 3, cost: 60,
    hp: 650, armor: 40, ah: 10, antihealOnDmg: { v: 0.40, dur: 3 }, parts: ["gpr", "bbt"] },
  ...
  { id: "hwh", th: "Horn of the Wild Hunt — เขาศึกไวลด์ฮันต์", cat: "FIGHTER", also: ["MARKSMAN"], tier: 3, cost: 60,
    ad: 40, hp: 300, asPct: 0.2, ah: 10, parts: ["hwt", "wha", "cc"] },
  ...
  { id: "fsd", th: "Freyja's Shroud of Defiance — ผ้าคลุมท้าความตายเฟรยา", cat: "ASSASSIN", uniq: ["lifeline"], tier: 3, cost: 64,
    ad: 50, pen: 10, ah: 15, denyDeath: { dur: 2 }, parts: ["hsd", "lmd", "nd"] },
  { id: "wvc", th: "Wendigo's Voracious Claw — กรงเล็บตะกละเวนดิโก", cat: "ASSASSIN", also: ["FIGHTER"], tier: 3, cost: 60,
    ad: 45, pen: 12, adPerKill: { per: 4, max: 10 }, parts: ["hsd", "fcl"] },
];
