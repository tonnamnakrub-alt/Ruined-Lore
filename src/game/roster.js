...
// ทุกค่าเปลี่ยน "สิ่งที่บอทตัดสินใจทำ" ไม่มีค่าไหนบวกลบดาเมจลับหลัง
export const STAT_DESC = {
  mechanics: "เล็งสกิลแม่น หลบสกิลทัน ออโต้พลาดน้อยกว่า",
  gameSense: "อ่านออกว่าใครกำลังเล่นงานเราหรือตัวเปราะของเรา แล้วหันไปจัดการคนนั้นก่อน · ถอยเป็น ยืนถูกระยะ",
  knowledge: "อ่านแมตช์อัพ — เลือกเป้าที่เรากินได้เร็วจริง หลังหักเกราะและต้านเวทของเขาแล้ว",
  decision: "อดใจรออัลติให้คุ้ม จังหวะเข้าถอย และไม่ไล่จนหลุดทีม",
  teamwork: "ตีเป้าเดียวกับเพื่อน และไม่ไปสมทบเป้าที่เพื่อนเก็บอยู่แล้ว ย้ายไปตัวถัดไปแทน",
};
